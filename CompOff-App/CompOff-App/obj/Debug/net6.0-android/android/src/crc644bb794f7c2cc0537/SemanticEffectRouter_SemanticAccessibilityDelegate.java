...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.CommunityToolkit.Android.Effects.SemanticEffectRouter+SemanticAccessibilityDelegate, Xamarin.CommunityToolkit.MauiCompat", SemanticEffectRouter_SemanticAccessibilityDelegate.class, __md_methods);
	}
	...
	public SemanticEffectRouter_SemanticAccessibilityDelegate ()
	{
		...
		if (getClass () == SemanticEffectRouter_SemanticAccessibilityDelegate.class)
			mono.android.TypeManager.Activate ("Xamarin.CommunityToolkit.Android.Effects.SemanticEffectRouter+SemanticAccessibilityDelegate, Xamarin.CommunityToolkit.MauiCompat", "", this, new java.lang.Object[] {  });
	}
	...
	public SemanticEffectRouter_SemanticAccessibilityDelegate (android.view.View.AccessibilityDelegate p0)
	{
		super (p0);
		if (getClass () == SemanticEffectRouter_SemanticAccessibilityDelegate.class)
			mono.android.TypeManager.Activate ("Xamarin.CommunityToolkit.Android.Effects.SemanticEffectRouter+SemanticAccessibilityDelegate, Xamarin.CommunityToolkit.MauiCompat", "Android.Views.View+AccessibilityDelegate, Mono.Android", this, new java.lang.Object[] { p0 });
	}
