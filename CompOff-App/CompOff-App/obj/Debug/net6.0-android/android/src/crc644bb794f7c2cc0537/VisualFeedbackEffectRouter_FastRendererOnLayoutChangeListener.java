...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.CommunityToolkit.Android.Effects.VisualFeedbackEffectRouter+FastRendererOnLayoutChangeListener, Xamarin.CommunityToolkit.MauiCompat", VisualFeedbackEffectRouter_FastRendererOnLayoutChangeListener.class, __md_methods);
	}
	...
	public VisualFeedbackEffectRouter_FastRendererOnLayoutChangeListener ()
	{
		...
		if (getClass () == VisualFeedbackEffectRouter_FastRendererOnLayoutChangeListener.class)
			mono.android.TypeManager.Activate ("Xamarin.CommunityToolkit.Android.Effects.VisualFeedbackEffectRouter+FastRendererOnLayoutChangeListener, Xamarin.CommunityToolkit.MauiCompat", "", this, new java.lang.Object[] {  });
	}
