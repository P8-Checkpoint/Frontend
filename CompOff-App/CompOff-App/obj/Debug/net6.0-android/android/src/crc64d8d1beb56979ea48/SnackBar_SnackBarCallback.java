...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.CommunityToolkit.UI.Views.SnackBar+SnackBarCallback, Xamarin.CommunityToolkit.MauiCompat", SnackBar_SnackBarCallback.class, __md_methods);
	}
	...
	public SnackBar_SnackBarCallback ()
	{
		...
		if (getClass () == SnackBar_SnackBarCallback.class)
			mono.android.TypeManager.Activate ("Xamarin.CommunityToolkit.UI.Views.SnackBar+SnackBarCallback, Xamarin.CommunityToolkit.MauiCompat", "", this, new java.lang.Object[] {  });
	}
