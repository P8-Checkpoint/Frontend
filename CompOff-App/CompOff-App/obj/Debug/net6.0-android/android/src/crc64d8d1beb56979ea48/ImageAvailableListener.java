...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.CommunityToolkit.UI.Views.ImageAvailableListener, Xamarin.CommunityToolkit.MauiCompat", ImageAvailableListener.class, __md_methods);
	}
	...
	public ImageAvailableListener ()
	{
		...
		if (getClass () == ImageAvailableListener.class)
			mono.android.TypeManager.Activate ("Xamarin.CommunityToolkit.UI.Views.ImageAvailableListener, Xamarin.CommunityToolkit.MauiCompat", "", this, new java.lang.Object[] {  });
	}
