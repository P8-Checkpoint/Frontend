...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.CommunityToolkit.UI.Views.CameraCaptureListener, Xamarin.CommunityToolkit.MauiCompat", CameraCaptureListener.class, __md_methods);
	}
	...
	public CameraCaptureListener ()
	{
		...
		if (getClass () == CameraCaptureListener.class)
			mono.android.TypeManager.Activate ("Xamarin.CommunityToolkit.UI.Views.CameraCaptureListener, Xamarin.CommunityToolkit.MauiCompat", "", this, new java.lang.Object[] {  });
	}
