...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.CommunityToolkit.UI.Views.CameraCaptureStateListener, Xamarin.CommunityToolkit.MauiCompat", CameraCaptureStateListener.class, __md_methods);
	}
	...
	public CameraCaptureStateListener ()
	{
		...
		if (getClass () == CameraCaptureStateListener.class)
			mono.android.TypeManager.Activate ("Xamarin.CommunityToolkit.UI.Views.CameraCaptureStateListener, Xamarin.CommunityToolkit.MauiCompat", "", this, new java.lang.Object[] {  });
	}
