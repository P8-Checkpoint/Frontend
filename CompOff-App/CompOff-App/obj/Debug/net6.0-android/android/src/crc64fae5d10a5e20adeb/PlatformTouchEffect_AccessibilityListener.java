...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.CommunityToolkit.Ports.Android.Effects.PlatformTouchEffect+AccessibilityListener, App", PlatformTouchEffect_AccessibilityListener.class, __md_methods);
	}
	...
	public PlatformTouchEffect_AccessibilityListener ()
	{
		...
		if (getClass () == PlatformTouchEffect_AccessibilityListener.class)
			mono.android.TypeManager.Activate ("Xamarin.CommunityToolkit.Ports.Android.Effects.PlatformTouchEffect+AccessibilityListener, App", "", this, new java.lang.Object[] {  });
	}
