...
namespace Xamarin.CommunityToolkit.Ports.iOS.Effects
{
...
#pragma warning restore CS8603 // Possible null reference return.
    ...
    public override void TouchesMoved( NSSet touches, UIEvent evt )
    {
      ...
      // Work-around / Hack: The GetRenderer method returns null, which results in the point variable being null
      // for now we just accept TouchStatus.Started if point is null
      var status = TouchStatus.Started;
